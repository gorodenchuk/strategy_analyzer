...
public class EntryModelsTest extends BaseTest {
    ...
    public void entryAfterSweepWithEntryModelOnMinus2TF() throws IOException {
        String data = fileRoutine.readResourceAsString("response/gbp-usd/daily-4h-1h/", "GBP_USD_D_210_candles.json");
        ...
        String dataMinus1TF = fileRoutine.readResourceAsString("response/gbp-usd/daily-4h-1h/", "GBP_USD_H4_1250_candles.json");
        ...
        String dataMinus2TF = fileRoutine.readResourceAsString("response/gbp-usd/daily-4h-1h/", "GBP_USD_H1_5000_candles.json");
