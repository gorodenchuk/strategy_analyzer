...
public class EntryModelsStatistic extends BaseStatistic {
    ...
    public void smrHighFractalTarget(double risk, double rrMin, List<Candle> sweepLiquidityCandles, List<Candle> fractalsLow, List<Candle> candlesOnMinus1TF, List<Candle> fractalsHighMinus1TF, List<Candle> candlesOnMinus2TF, List<Candle> fractalsHighMinus2TF, List<Candle> fractalsLowMinus2TF) {
        ...
        for (Candle candleParent : sweepLiquidityCandles) {
            ...
            if (candleInvlMinus1TF != null) {
                int index = candleHelper.getHighFractalIndexBeforeSweep(fractalsHighMinus1TF,
                    candleInvlMinus1TF);

                if (index != -1) {
                    Candle takeProfitMinus1TF = fractalsHighMinus1TF.get(index);
                    Candle takeProfitMinus2TF = candleHelper.getCandleByHigh(candlesOnMinus2TF,
                        takeProfitMinus1TF);
                    Candle candleInvlMinus2TF = candleHelper.getCandleByLow(candlesOnMinus2TF,
                        candleInvlMinus1TF);

                    Candle rebalancedFractalMinus2TF = candleHelper.getLowRebalancedFractalMinus2TF(
                        candlesOnMinus2TF, fractalsLow, candleInvlMinus1TF);
                    Candle smrVlCandle = candleHelper.getTargetHighLevelValidation(
                        candlesOnMinus2TF, fractalsHighMinus2TF, candleInvlMinus2TF);

                    if (rebalancedFractalMinus2TF != null && smrVlCandle != null) {
                        double entry = Double.parseDouble(
                            entryPoint.getBosHighLevel(fractalsHighMinus2TF, candleInvlMinus2TF)
                                .getMid().getH());
                        ...
                        String targetResult = target.getReachedHighFractalTarget(candlesOnMinus2TF,
                            takeProfitMinus2TF, candleInvlMinus2TF);

                        smr = new Smr(fractalsLowMinus2TF, fractalsHighMinus2TF, candlesOnMinus2TF,
                            candleInvlMinus2TF, rebalancedFractalMinus2TF, smrVlCandle);
    ...
    public void smrLowFractalTarget(double risk, double rrMin, List<Candle> sweepLiquidityCandles, List<Candle> fractalsHigh, List<Candle> candlesOnMinus1TF, List<Candle> fractalsLowMinus1TF, List<Candle> candlesOnMinus2TF, List<Candle> fractalsLowMinus2TF, List<Candle> fractalsHighMinus2TF) {
        for (Candle candleParent : sweepLiquidityCandles) {
            ...
            if (candleInvlMinus1TF != null) {
                ...
                if (index != -1) {
                    ...
                    if (rebalancedFractalMinus2TF != null && smrVlCandle != null) {
                        double entry = Double.parseDouble(
                            entryPoint.getBosLowLevel(fractalsLowMinus2TF, candleInvlMinus2TF)
                                .getMid().getL());
                        ...
                        String targetResult = target.getReachedLowFractalTarget(candlesOnMinus2TF,
                            takeProfitMinus2TF, candleInvlMinus2TF);
        ...
        public void smrHighFractalTarget(double risk, double rrMin, List<Candle> sweepLiquidityCandles, List<Candle> fractalsLow, List<Candle> fractalsHigh, List<Candle> candlesOnMinus1TF, List<Candle> fractalsHighMinus1TF, List<Candle> candlesOnMinus2TF, List<Candle> fractalsHighMinus2TF, List<Candle> fractalsLowMinus2TF) {
            ...
            for (Candle candleParent : sweepLiquidityCandles) {
                ...
                if (index != -1 && candleInvlMinus1TF != null) {
                    Candle takeProfitContextTF = fractalsHigh.get(index);
                    Candle takeProfitMinus1TF = candleHelper.getCandleByHigh(candlesOnMinus1TF,
                        takeProfitContextTF);
                    Candle takeProfitMinus2TF = candleHelper.getCandleByHigh(candlesOnMinus2TF,
                        takeProfitMinus1TF);
                    Candle candleInvlMinus2TF = candleHelper.getCandleByLow(candlesOnMinus2TF,
        ...
        public void smrLowFractalTarget(double risk, double rrMin, List<Candle> sweepLiquidityCandles, List<Candle> fractalsHigh, List<Candle> fractalsLow, List<Candle> candlesOnMinus1TF, List<Candle> fractalsLowMinus1TF, List<Candle> candlesOnMinus2TF, List<Candle> fractalsLowMinus2TF, List<Candle> fractalsHighMinus2TF) {
            for (Candle candleParent : sweepLiquidityCandles) {
                ...
                if (candleInvlMinus1TF != null) {
                    int index = candleHelper.getLowFractalIndexBeforeSweep(fractalsLow,
                        candleParent);

                    if (index != -1 && candleInvlMinus1TF != null) {
                        Candle takeProfitContextTF = fractalsLow.get(index);
                        Candle takeProfitMinus1TF = candleHelper.getCandleByLow(candlesOnMinus1TF,
                            takeProfitContextTF);
                        Candle takeProfitMinus2TF = candleHelper.getCandleByLow(candlesOnMinus2TF,
                            takeProfitMinus1TF);
                        Candle candleInvlMinus2TF = candleHelper.getCandleByHigh(candlesOnMinus2TF,
                        ...
                        Candle rebalancedFractalMinus2TF = candleHelper.getHighRebalancedFractalMinus2TF(
                            candlesOnMinus2TF, fractalsHigh, candleInvlMinus1TF);
                        Candle smrVlCandle = candleHelper.getTargetLowLevelValidation(
                            candlesOnMinus2TF,
                            fractalsLowMinus2TF, candleInvlMinus2TF);
                        ...
                        if (rebalancedFractalMinus2TF != null && smrVlCandle != null) {
                            double entry = Double.parseDouble(
                                entryPoint.getBosLowLevel(fractalsLowMinus2TF, candleInvlMinus2TF)
                                    .getMid().getL());
                            double takeProfit = Double.parseDouble(
                                takeProfitMinus2TF.getMid().getL());
                            double stopLoss = Double.parseDouble(
                                candleInvlMinus2TF.getMid().getH());
                            String targetResult = target.getReachedLowFractalTarget(
                                candlesOnMinus2TF,
                                takeProfitMinus2TF, candleInvlMinus2TF);

                            smr = new Smr(fractalsLowMinus2TF, fractalsHighMinus2TF,
                                candlesOnMinus2TF,
                                candleInvlMinus2TF, rebalancedFractalMinus2TF, smrVlCandle);
                            riskRewards = new RiskRewards(entry, takeProfit, stopLoss, risk, rrMin);
